...
namespace bymayo\barcode;

use bymayo\barcode\services\BarcodeService as BarcodeService;
use bymayo\barcode\variables\BarcodeVariable;
...
class Barcode extends Plugin
{
    ...
    public function init()
    {
        ...
        $this->setComponents([
            'barcodeService' => \bymayo\barcode\services\BarcodeService::class,
        ]);
